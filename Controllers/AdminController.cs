        ...
        public async Task<IActionResult> Dashboard()
        {
            try
            {
                var viewModel = new DashboardViewModel
                {
                    ...
                    TotalDonations = await _context.Donations.Where(d => d.Status == "Approved").SumAsync(d => d.Amount),
                    RejectedDonations = await _context.Donations.Where(d => d.Status == "Rejected").SumAsync(d => d.Amount),
